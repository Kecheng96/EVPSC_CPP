...
其中, $L'_{ijkl}=w^p_{ik}\sigma_{kj}-\sigma_{ik}w^p_{kj}$, $L'_{ijkl}=L_{ijkl}-\sigma_{ij}\delta_{kl}$ , $\sigma^0_{ij}=w^p_{ik}\sigma_{kj}-\sigma_{ik}w^p_{kj}$ , 进而得到应变率张量与客观应力率的关系:
